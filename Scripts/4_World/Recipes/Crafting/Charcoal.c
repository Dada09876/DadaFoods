class CraftDadaCharcoalPiece extends RecipeBase
{
	override void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"Edible_Base");//you can insert multiple ingredients this w
...
class CraftDadaCharcoalTabs extends RecipeBase
{
	override void Init()
	{
