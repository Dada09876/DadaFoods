...
class CraftDadaDrink_MilkShake1 extends Craft_DadaTempStage_BaseRecipe
{
	override void Init()
	{
		super.Init();
		...
		m_MinQuantityIngredient[0] = 100;//-1 = disable check
		m_MinQuantityIngredient[1] = 38;//-1 = disable check
		...
		//ingredient 2
        InsertIngredient(1,"PowderedMilk");//you can insert multiple ingredients this w
...
class CraftDadaDrink_MilkCoffee2 extends Craft_DadaTempStage_BaseRecipe
{
	override void Init()
	{
		super.Init();
...
class CraftDadaDrink_MilkCoffeeArt2 extends Craft_DadaTempStageTemp1Stage1_BaseRecipe
{
	override void Init()
	{
		super.Init();
...
class CraftDadaDrink_MatchaTea extends Craft_DadaTemp1Liquid1_BaseRecipe
{
	override void Init()
	{
		super.Init();
		...
		InsertIngredient(0,"DadaMatchaTeaPacket");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("DadaDrink_MatchaTea");//add results here
