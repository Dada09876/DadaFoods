class CraftBoxCerealCrunchin extends RecipeBase
{
	override void Init()
	{
...
class CraftDadaSpawned_BoxCerealCrunchin_Kosmostar extends RecipeBase
{
	override void Init()
	{
...
class CraftDadaSpawned_BoxCerealCrunchin_Frosties extends RecipeBase
{
	override void Init()
	{
...
class CraftDadaSpawned_BoxCerealCrunchin_Nesquik extends RecipeBase
{
	override void Init()
	{
