...
class Craft_DadaCannibal_RawFoodCan_STAGham extends
Craft STAG Ham Can

class Craft_DadaCannibal_RawFoodCan_ESPENChunkySoup extends
Craft ESPENLock Chunky Soup

class Craft_DadaCannibal_RawFoodCan_LSSPAM extends
Craft ESPENLock SPAM Can

class Craft_DadaCannibal_RawFoodCan_STAGchili extends
Craft STAG Chili Can

class Craft_DadaCannibal_RawFoodCan_DicedTomatoes extends
Craft Diced Tomatoes Can

class Craft_DadaCannibal_RawFoodCan_Ketchup extends
Craft Ketchup Can

class Craft_DadaCannibal_RawFoodCan_HomemadeChili extends
