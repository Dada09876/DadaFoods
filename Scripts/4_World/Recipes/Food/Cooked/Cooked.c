...
class CraftDadaDish_Spaghetti2 extends Craft_DadaTempStage_BaseRecipe
{
	override void Init()
	{
		...
		InsertIngredient(1,"Dada_PreservedFoodCan_STAGchili");//you can insert multiple ingredients this way
		InsertIngredient(1,"Dada_PreservedFoodCan_HomemadeChili");//you can insert multiple ingredients this way
...
class CraftDadaDish_PulledPork2 extends Craft_DadaTemp1Stage1_BaseRecipe
{
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Dada_PreservedFoodCan_Ketchup");
		InsertIngredient(0,"Dada_PreservedFoodCan_DicedTomatoes");//you can insert multiple ingredients this way
...
class CraftDadaSoup_Ragout1 extends Craft_DadaTempStage_BaseRecipe
{
	override void Init()
	{
		super.Init();
...
class CraftDadaDish_Gumbo4 extends Craft_DadaTempStage_BaseRecipe
{
	override void Init()
	{
		super.Init();
