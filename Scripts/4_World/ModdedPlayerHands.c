...

{
    override void RegisterOneHanded(DayZPlayerType pType, DayzPlayerItemBehaviorCfg pBehavior)
    {
        ...
        pType.AddItemInHandsProfileIK("DadaRaw_Mozza", "dz/anims/workspaces/player/player_main/props/player_main_1h_fruit.asi",pBehavior,"dz/anims/anm/player/ik/gear/apple.anm");
        pType.AddItemInHandsProfileIK("DadaRaw_FreshGoatCheese","dz/anims/workspaces/player/player_main/player_main_1h.asi",pBehavior,"dz/anims/anm/player/ik/gear/banana.anm");
        pType.AddItemInHandsProfileIK("DadaRaw_VanillaChocoSwirl","dz/anims/workspaces/player/player_main/props/player_main_1h_torch.asi",pBehavior,"dz/anims/anm/player/ik/gear/GasLight.anm");
        pType.AddItemInHandsProfileIK("DadaRaw_VanillaIceCream","dz/anims/workspaces/player/player_main/props/player_main_1h_torch.asi",pBehavior,"dz/anims/anm/player/ik/gear/GasLight.anm");
        pType.AddItemInHandsProfileIK("DadaRaw_ChocoIScream","dz/anims/workspaces/player/player_main/props/player_main_1h_torch.asi",pBehavior,"dz/anims/anm/player/ik/gear/GasLight.anm");
        pType.AddItemInHandsProfileIK("DadaRaw_FrozenYogurt","dz/anims/workspaces/player/player_main/props/player_main_1h_torch.asi",pBehavior,"dz/anims/anm/player/ik/gear/GasLight.anm");
        pType.AddItemInHandsProfileIK("DadaRaw_CheddarCurds","dz/anims/workspaces/player/player_main/player_main_1h.asi",pBehavior,"dz/anims/anm/player/ik/gear/BloodBag_Sealed.anm");
       ...
       /* pType.AddItemInHandsProfileIK("crab_claw", "dz/anims/workspaces/player/player_main/props/player_main_1h_fruit.asi", pBehavior,"dz/anims/anm/player/ik/gear/apple.anm");
        ...
        pType.AddItemInHandsProfileIK("DadaRaw_SushiOnigiri","dz/anims/workspaces/player/player_main/player_main_1h.asi",pBehavior,"dz/anims/anm/player/ik/gear/foodcan100g.anm");
        pType.AddItemInHandsProfileIK("DadaRaw_SushiMaki","dz/anims/workspaces/player/player_main/player_main_1h.asi",pBehavior,"dz/anims/anm/player/ik/gear/foodcan100g.anm");
